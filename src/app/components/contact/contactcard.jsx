...
const Contactcard = ({ message, description, cmessage }) => {
  return (
    <div className=" border dark:border-gray-600 border-black w-80 lg:w-60 h-56 rounded-md flex flex-col justify-between">
      <div className="bg-blue-900 rounded-md p-2 w-fit m-2">
      ...
      <div className="mb-3 flex flex-col gap-3 m-2">
        ...
        <button className="font-[600] dark:text-white text-black border dark:border-gray-600 border-black cursor-pointer p-1 rounded-md w-fit text-sm">
          {cmessage}
        </button>
      </div>
    </div>
