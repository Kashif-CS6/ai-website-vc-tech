...
const Numbercard = ({ number, heading }) => {
  return (
    <div className="w-48 md:w-full h-28 md:h-44  md:border-l lg:border-l-0 border-r border-gray-200 dark:border-gray-800 border-t border-b  flex flex-col justify-center items-center">
