...
function Teams() {
  return (
    <div
      className="dark:bg-custom-bluish bg-normal-white py-4 "
      
    >
      <div className="dark:lg:bg-[url('/bgpattern.png')] object-contain lg:w-8/12 flex justify-center lg:mx-auto h-32">
